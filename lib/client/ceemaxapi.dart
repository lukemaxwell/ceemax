...
library server_code_lab.ceemaxApi.client;
...
const core.String USER_AGENT = 'dart-api-client ceemaxApi/v1';

class CeemaxApi {

  final commons.ApiRequester _requester;

  CeemaxApi(http.Client client, {core.String rootUrl: "http://localhost:8080/", core.String servicePath: "ceemaxApi/v1/"}) :
